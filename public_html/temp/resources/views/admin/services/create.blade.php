    ...
    <div class="col-sm-10">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h5 class="m-0 font-weight-bold text-white">Xidməti Əlavə Etmə</h5>
            </div>
            <div class="card-body">
                {!! Form::open(['method'=>'POST', 'action'=>['AdminServicesController@store'], 'files'=>true  ]) !!}
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="tab-content">
                            <div id="about_az" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    {!! Form::label('title_az', 'Xidmət Adı AZ:') !!}
                            ...
                            <div id="about_ru" class="tab-pane fade">
                                ...
                                <div class="form-group">
                                    {!! Form::label('title_ru', 'Xidmət Adı RU:') !!}
                            ...
                            <div id="about_en" class="tab-pane fade">
                                ...
                                <div class="form-group">
                                    {!! Form::label('title_en', 'Xidmət Adı EN:') !!}
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <label >Xidmət üçün şəkil seçin</label>
                                <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <select class="form-control" name="parent">
                                    ...
                                    @foreach($servicesEx as $serviceEx)
                                        <option value="{{ $serviceEx->id }}">{{ $serviceEx->title_az }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-12 col-md-6">
                        ...
                        <div class="col-sm-12" style="text-align: right;">
                            <div class="form-group">
                                {!!  Form::submit('Xidməti Yarat', ['class'=>'btn btn-primary col-sm-2']) !!}
                            </div>
                        </div>
