    ...
    <div class="col-sm-10">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h5 class="m-0 font-weight-bold text-white">Layihə Əlavə olunması</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="about_en" class="tab-pane fade">
                                <br/>
                                <a class="btn btn-primary" data-toggle="collapse" href="#seoENG" role="button"
                                   aria-expanded="false" aria-controls="collapseExample">
                                    SEO tools
                                </a>
                                <hr>
                                <div class="collapse" id="seoENG">
                                    <div class="form-group">
                                        {!! Form::label('seo_title_en', 'SEO Title ENG:') !!}
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('seo_keywords_en', 'SEO Keywords ENG:') !!}
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('seo_desctioption_en', 'SEO Description ENG:') !!}
                                ...
                                <div class="form-group">
                                    {!! Form::label('title_en', 'Başlıq ENG:') !!}
                                ...
                                <div class="form-group">
                                    {!! Form::label('short_en', 'Qısa təsvir  ENG:') !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control">
                                            ...
                                            @foreach($services as $service)
                                                <option value="{{$service->id}}">{{$service->title_az}}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="col-sm-12" style="text-align: right;">
                            <div class="form-group">
                                {!!  Form::submit('Layihəni Yarat', ['class'=>'btn btn-primary col-sm-2']) !!}
                            </div>
                        </div>
