                        ...
                        <div class="tab-content">
                            ...
                            <div id="about_ru" class="tab-pane fade">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('short_ru', $blog->short_ru, ['class' => ($errors->has('short_ru')) ? 'form-control form-error' : 'form-control']) !!}
                                    <small class="text-danger">{{ $errors->first('short_ru') }}</small>
                                </div>
                                <div class="form-group">
                                    {!! Form::label('text_ru', 'Metn RU:') !!}
                                    {!! Form::textarea('text_ru', $blog->text_ru, ['class' => ($errors->has('text_ru')) ? 'form-control form-error textarea' : 'form-control textarea']) !!}
                            ...
                            <div id="about_en" class="tab-pane fade">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('short_en', $blog->short_en, ['class' => ($errors->has('short_en')) ? 'form-control form-error' : 'form-control']) !!}
                                    <small class="text-danger">{{ $errors->first('short_en') }}</small>
                                </div>
                                <div class="form-group">
                                    {!! Form::label('text_en', 'Metn EN:') !!}
                                    {!! Form::textarea('text_en', $blog->text_en, ['class' => ($errors->has('text_en')) ? 'form-control form-error textarea' : 'form-control textarea']) !!}
