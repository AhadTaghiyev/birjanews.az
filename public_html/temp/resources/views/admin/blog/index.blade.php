    ...
    <div class="col-sm-10">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h5 class="m-0 font-weight-bold text-white">Blog</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="collapse" id="seo">
                            ...
                            {!! Form::model($blogsSeo, ['method'=>'PATCH', 'action'=>['AdminBlogsSeoController@update', $blogsSeo[0]->id] ]) !!}
                    ...
                    <div class="col-sm-6">
                        <a href="{{route('admin.blog.create')}}" class="pull-right margin-bottom-20"><button type="button" class="btn btn-primary">Blog Yarat</button></a>
                    </div>
                </div>
                    ...
                    @if($blogs)
                        @foreach($blogs as $blog)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <a href="{{route('admin.blog.edit', $blog->id)}}" class="btn btn-primary margin-right-5"><i class="fas fa-edit"></i> Dəyiş</a>
