    ...
    <div class="col-sm-10">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h5 class="m-0 font-weight-bold text-white">Qalereya Kategoriyaları</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <a href="{{route('admin.gallery.index')}}" class="pull-right margin-bottom-20 btn btn-success">
                            Qalereya
                        </a>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="modal fade" id="category" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                {!! Form::open(['method'=>'POST', 'action'=>['AdminGalleryCategoryController@store'] , 'files'=>true]) !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="modal fade" id="category{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    {!! Form::model($category, ['method'=>'PATCH', 'action'=>['AdminGalleryCategoryController@update', $category->id], 'files'=>true ]) !!}
                                                    <div class="modal-body">
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                        <ul class="nav nav-tabs">
                                                            <li class="nav-item">
                                        ...
                                        {!! Form::open(['method'=>'DELETE', 'action'=>['AdminGalleryCategoryController@destroy', $category->id]]) !!}
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
