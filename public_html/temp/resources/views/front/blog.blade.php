...
@section('content')
    ...
    <section class="banner-section overlay banner-section-blog">
        <div class="banner-inner">
            ...
            <nav class="mt-70" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('blogs', app()->getLocale()) }}">@lang('menu.Blog')</a></li>
                    ...
                    <div class="sidebar rmt-100">
                        ...
                        <div class="widget recent-post-widget wow  delay-0-5s slow">
                            ...
                            <div class="recent-posts">
                                ...
                                <div class="post-item">
                                    <div class="post-img">
                                        <a href="{{ route('blog', ['id'=>$blog2->id, 'locale'=>app()->getLocale()]) }}"><img src="{{asset('files/img/blog/'.$blog2->photo->file)}}" alt="$blog2->photo->alt_tag"></a>
                                    </div>
