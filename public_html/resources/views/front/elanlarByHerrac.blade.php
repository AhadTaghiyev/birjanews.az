    ...
    <div class="tg-bannerinnerpage">
        <div class="container">
            <ol class="tg-breadcrumb">
                ...
                <li class="tg-active">Hərrac</li>
                <li class="tg-active">{{ $selectedPartner[0]->name }}</li>
            </ol>
        </div>
    </div>
                                                ...
                                                <div class="tg-postcontent">
                                                    <div class="tg-borderleft">
                                                        ...
                                                        <div class="tg-posttitle tg-posttitlelarge">
                                                            <h3><a href="{{ route('herracElan', $elan->id) }}">{{ $elan->title_az }}</a></h3>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <ul class="tg-postmatadata">
                                                        <li>
                                                            <span class="lnr lnr-calendar-full">ttt</span>
                                                    ...
                                                    <div class="tg-postbtnbox">
                                                        <a class="tg-btn" href="{{ route('herracElan', $elan->id) }}">Ətraflı</a>
                                                    </div>
                                                </div>
                                            </article>
                                        @endforeach
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div id="tg-content" class="tg-content">
                            ...
                            <div class="style-btn-all">
                                <a href="{{ route('herracElanlar') }}" class="tg-btn btn_custom margin-tb-10">Bütün Hərraclar Keçid</a>
                            </div>
                        </div>
                    </div>
                </div>
