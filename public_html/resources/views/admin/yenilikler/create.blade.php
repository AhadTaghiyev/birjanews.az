...
@section('content')
    ...
    <div class="col">
        <section class="card">
            <div class="row">
                <div class="col-sm-12">
                    <a href="{{route('admin.yenilikler.index')}}"
            ...
            <div class="card-body">
                {!! Form::open(['method'=>'POST', 'action'=>['AdminYeniliklerController@store'], 'files'=>true, 'class'=>'form-horizontal form-bordered' ]) !!}
