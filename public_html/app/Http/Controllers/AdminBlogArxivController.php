...
class AdminBlogArxivController extends Controller
{
    /**
    ...
    {
        echo 'asd';
        $blogs = Blog::where('type', 1)->where('status', 0)->get();

        return view('admin.arxiv.index', compact('blogs'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.arxiv.edit', compact('blog', 'partners', 'tags'));
    }
